...
public unsafe partial class CREATE_USN_JOURNAL_DATA : IDisposable
{
    ...
    internal static readonly ConcurrentDictionary<IntPtr, CREATE_USN_JOURNAL_DATA> NativeToManagedMap =
        new ConcurrentDictionary<IntPtr, CREATE_USN_JOURNAL_DATA>();

    internal static void __RecordNativeToManagedMapping(IntPtr native, CREATE_USN_JOURNAL_DATA managed)
    {
        NativeToManagedMap[native] = managed;
    }

    internal static bool __TryGetNativeToManagedMapping(IntPtr native, out CREATE_USN_JOURNAL_DATA managed)
    {
