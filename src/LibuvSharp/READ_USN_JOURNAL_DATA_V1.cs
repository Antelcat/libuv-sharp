...
public unsafe partial class READ_USN_JOURNAL_DATA_V1 : IDisposable
{
    ...
    internal static readonly ConcurrentDictionary<IntPtr, READ_USN_JOURNAL_DATA_V1> NativeToManagedMap =
        new ConcurrentDictionary<IntPtr, READ_USN_JOURNAL_DATA_V1>();

    internal static void __RecordNativeToManagedMapping(IntPtr native, READ_USN_JOURNAL_DATA_V1 managed)
    {
        NativeToManagedMap[native] = managed;
    }

    internal static bool __TryGetNativeToManagedMapping(IntPtr native, out READ_USN_JOURNAL_DATA_V1 managed)
    {
