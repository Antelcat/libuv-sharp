...
public unsafe partial class UvReqS : IDisposable
{
    ...
    public struct __Internal
    {
        ...
        [SuppressUnmanagedCodeSecurity, DllImport(LibuvSharp.libuv, EntryPoint = "??0uv_req_s@@QEAA@AEBU0@@Z", CallingConvention = CallingConvention.Cdecl)]
    ...
    public partial struct U
    {
        ...
        public struct __Internal
        {
            ...
            [SuppressUnmanagedCodeSecurity, DllImport(LibuvSharp.libuv, EntryPoint = "??0<unnamed-type-u>@uv_req_s@@QEAA@AEBT01@@Z", CallingConvention = CallingConvention.Cdecl)]
        ...
        public partial class Connect : IDisposable
        {
            ...
            public struct __Internal
            {
                ...
                [SuppressUnmanagedCodeSecurity, DllImport(LibuvSharp.libuv, EntryPoint = "??0<unnamed-type-io>@<unnamed-type-u>@uv_req_s@@QEAA@AEBU012@@Z", CallingConvention = CallingConvention.Cdecl)]
                internal static extern IntPtr cctor(IntPtr __instance, IntPtr __0);
            }
    ...
    internal static readonly ConcurrentDictionary<IntPtr, UvReqS> NativeToManagedMap =
        new ConcurrentDictionary<IntPtr, UvReqS>();

    internal static void __RecordNativeToManagedMapping(IntPtr native, UvReqS managed)
    {
        NativeToManagedMap[native] = managed;
    }

    internal static bool __TryGetNativeToManagedMapping(IntPtr native, out UvReqS managed)
    {
    ...
    public UvReqS NextReq
    {
        get
        {
            var __result0 = __GetOrCreateInstance(((__Internal*)__Instance)->next_req);
            return __result0;
        }
