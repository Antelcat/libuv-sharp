...
public static class IMessageSenderExtensions
{
	...
	public static void Send<TMessage>(this IMessageSender<TMessage> sender, 
		string ipAddress, 
		int port, 
		byte[] data,
	...
	public static void Send<TMessage>(this IMessageSender<TMessage> sender, IPAddress ipAddress, int port,
		byte[] data)
		where TMessage : IMessage<IPEndPoint, ArraySegment<byte>>, new()
	{
		sender.Send(ipAddress, port, data, null);
	...
	public static void Send<TMessage, TEndPoint>(this IMessageSender<TMessage> sender, 
		TEndPoint endPoint,
		byte[] data, 
		Action<Exception> callback)
	...
	public static void Send<TMessage, TEndPoint>(this IMessageSender<TMessage> sender, TEndPoint endPoint,
		byte[] data)
		where TMessage : IMessage<TEndPoint, ArraySegment<byte>>, new()
	{
	...
	public static void Send<TMessage, TPayload>(this IMessageSender<TMessage> sender, 
		string ipAddress, 
		int port,
		TPayload payload, 
		Action<Exception> callback)
	...
	public static void Send<TMessage, TEndPoint, TPayload>(this IMessageSender<TMessage> sender, 
		TEndPoint endPoint,
		TPayload payload, 
		Action<Exception> callback)
