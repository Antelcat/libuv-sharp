...
public unsafe partial class MFT_ENUM_DATA_V1 : IDisposable
{
    ...
    internal static readonly ConcurrentDictionary<IntPtr, MFT_ENUM_DATA_V1> NativeToManagedMap =
        new ConcurrentDictionary<IntPtr, MFT_ENUM_DATA_V1>();

    internal static void __RecordNativeToManagedMapping(IntPtr native, MFT_ENUM_DATA_V1 managed)
    {
        NativeToManagedMap[native] = managed;
    }

    internal static bool __TryGetNativeToManagedMapping(IntPtr native, out MFT_ENUM_DATA_V1 managed)
    {
