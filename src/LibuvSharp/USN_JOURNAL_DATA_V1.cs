...
public unsafe partial class USN_JOURNAL_DATA_V1 : IDisposable
{
    ...
    internal static readonly ConcurrentDictionary<IntPtr, USN_JOURNAL_DATA_V1> NativeToManagedMap =
        new ConcurrentDictionary<IntPtr, USN_JOURNAL_DATA_V1>();

    internal static void __RecordNativeToManagedMapping(IntPtr native, USN_JOURNAL_DATA_V1 managed)
    {
        NativeToManagedMap[native] = managed;
    }

    internal static bool __TryGetNativeToManagedMapping(IntPtr native, out USN_JOURNAL_DATA_V1 managed)
    {
