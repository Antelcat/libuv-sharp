...
public unsafe partial class USN_JOURNAL_DATA_V0 : IDisposable
{
    ...
    internal static readonly ConcurrentDictionary<IntPtr, USN_JOURNAL_DATA_V0> NativeToManagedMap =
        new ConcurrentDictionary<IntPtr, USN_JOURNAL_DATA_V0>();

    internal static void __RecordNativeToManagedMapping(IntPtr native, USN_JOURNAL_DATA_V0 managed)
    {
        NativeToManagedMap[native] = managed;
    }

    internal static bool __TryGetNativeToManagedMapping(IntPtr native, out USN_JOURNAL_DATA_V0 managed)
    {
