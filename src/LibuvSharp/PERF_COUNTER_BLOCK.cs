...
public unsafe partial class PERF_COUNTER_BLOCK : IDisposable
{
    ...
    internal static readonly ConcurrentDictionary<IntPtr, PERF_COUNTER_BLOCK> NativeToManagedMap =
        new ConcurrentDictionary<IntPtr, PERF_COUNTER_BLOCK>();

    internal static void __RecordNativeToManagedMapping(IntPtr native, PERF_COUNTER_BLOCK managed)
    {
        NativeToManagedMap[native] = managed;
    }

    internal static bool __TryGetNativeToManagedMapping(IntPtr native, out PERF_COUNTER_BLOCK managed)
    {
