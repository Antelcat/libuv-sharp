...
public unsafe partial class FILE_SET_DEFECT_MGMT_BUFFER : IDisposable
{
    ...
    internal static readonly ConcurrentDictionary<IntPtr, FILE_SET_DEFECT_MGMT_BUFFER> NativeToManagedMap =
        new ConcurrentDictionary<IntPtr, FILE_SET_DEFECT_MGMT_BUFFER>();

    internal static void __RecordNativeToManagedMapping(IntPtr native, FILE_SET_DEFECT_MGMT_BUFFER managed)
    {
        NativeToManagedMap[native] = managed;
    }

    internal static bool __TryGetNativeToManagedMapping(IntPtr native, out FILE_SET_DEFECT_MGMT_BUFFER managed)
    {
