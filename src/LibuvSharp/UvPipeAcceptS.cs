...
public unsafe partial class UvPipeAcceptS : IDisposable
{
    ...
    public struct __Internal
    {
        ...
        [SuppressUnmanagedCodeSecurity, DllImport(LibuvSharp.libuv, EntryPoint = "??0uv_pipe_accept_s@@QEAA@AEBU0@@Z", CallingConvention = CallingConvention.Cdecl)]
    ...
    public partial struct U
    {
        ...
        public struct __Internal
        {
            ...
            [SuppressUnmanagedCodeSecurity, DllImport(LibuvSharp.libuv, EntryPoint = "??0<unnamed-type-u>@uv_pipe_accept_s@@QEAA@AEBT01@@Z", CallingConvention = CallingConvention.Cdecl)]
        ...
        public partial class Connect : IDisposable
        {
            ...
            public struct __Internal
            {
                ...
                [SuppressUnmanagedCodeSecurity, DllImport(LibuvSharp.libuv, EntryPoint = "??0<unnamed-type-io>@<unnamed-type-u>@uv_pipe_accept_s@@QEAA@AEBU012@@Z", CallingConvention = CallingConvention.Cdecl)]
                internal static extern IntPtr cctor(IntPtr __instance, IntPtr __0);
            }
    ...
    internal static readonly ConcurrentDictionary<IntPtr, UvPipeAcceptS> NativeToManagedMap =
        new ConcurrentDictionary<IntPtr, UvPipeAcceptS>();

    internal static void __RecordNativeToManagedMapping(IntPtr native, UvPipeAcceptS managed)
    {
        NativeToManagedMap[native] = managed;
    }

    internal static bool __TryGetNativeToManagedMapping(IntPtr native, out UvPipeAcceptS managed)
    {
    ...
    public UvPipeAcceptS(UvPipeAcceptS _0)
    {
        __Instance           = Marshal.AllocHGlobal(sizeof(__Internal));
        __ownsNativeInstance = true;
        __RecordNativeToManagedMapping(__Instance, this);
    ...
    public IntPtr PipeHandle
    {
        ...
        set => ((__Internal*)__Instance)->pipeHandle = value;
    }

    public UvPipeAcceptS NextPending
    {
        get
        {
