...
public unsafe partial class UvConnectS : IDisposable
{
    ...
    internal static readonly ConcurrentDictionary<IntPtr, UvConnectS> NativeToManagedMap =
        new ConcurrentDictionary<IntPtr, UvConnectS>();

    internal static void __RecordNativeToManagedMapping(IntPtr native, UvConnectS managed)
    {
        NativeToManagedMap[native] = managed;
    }

    internal static bool __TryGetNativeToManagedMapping(IntPtr native, out UvConnectS managed)
    {
    ...
    public UvConnectS(UvConnectS _0)
    {
        __Instance           = Marshal.AllocHGlobal(sizeof(__Internal));
        __ownsNativeInstance = true;
        __RecordNativeToManagedMapping(__Instance, this);
    ...
    public UvConnectCb Cb
    {
        get
        {
            var __ptr0 = ((__Internal*)__Instance)->cb;
            return __ptr0 == IntPtr.Zero? null : (UvConnectCb) Marshal.GetDelegateForFunctionPointer(__ptr0, typeof(UvConnectCb));
        }
