...
public class Udp(Loop loop) : HandleBase(loop, HandleType.UV_UDP, uv_udp_init), IMessageSender<UdpMessage>,
    IMessageReceiver<UdpReceiveMessage>, ITrySend<UdpMessage>, IBindable<Udp, IPEndPoint>
{
    ...
    public Udp() : this(Loop.Constructor)
    {
    }
