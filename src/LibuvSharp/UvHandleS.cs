...
public unsafe partial class UvHandleS : IDisposable
{
    ...
    public partial struct __Internal
    {
        ...
        [SuppressUnmanagedCodeSecurity, DllImport("LibuvSharp", EntryPoint = "??0uv_handle_s@@QEAA@AEBU0@@Z", CallingConvention = CallingConvention.Cdecl)]
    ...
    public unsafe partial struct U
    {
        ...
        public partial struct __Internal
        {
            ...
            [SuppressUnmanagedCodeSecurity, DllImport("LibuvSharp", EntryPoint = "??0<unnamed-type-u>@uv_handle_s@@QEAA@AEBT01@@Z", CallingConvention = CallingConvention.Cdecl)]
