...
public unsafe partial class FILE_INITIATE_REPAIR_OUTPUT_BUFFER : IDisposable
{
    ...
    internal static readonly ConcurrentDictionary<IntPtr, FILE_INITIATE_REPAIR_OUTPUT_BUFFER> NativeToManagedMap =
        new ConcurrentDictionary<IntPtr, FILE_INITIATE_REPAIR_OUTPUT_BUFFER>();

    internal static void __RecordNativeToManagedMapping(IntPtr native, FILE_INITIATE_REPAIR_OUTPUT_BUFFER managed)
    {
        NativeToManagedMap[native] = managed;
    }

    internal static bool __TryGetNativeToManagedMapping(IntPtr native, out FILE_INITIATE_REPAIR_OUTPUT_BUFFER managed)
    {
