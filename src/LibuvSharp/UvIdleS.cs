...
public unsafe partial class UvIdleS : IDisposable
{
    ...
    public partial struct __Internal
    {
        ...
        internal global::LibuvSharp.UvIdleS.U.__Internal u;
        ...
        [SuppressUnmanagedCodeSecurity, DllImport("LibuvSharp", EntryPoint = "??0uv_idle_s@@QEAA@AEBU0@@Z", CallingConvention = CallingConvention.Cdecl)]
    ...
    public unsafe partial struct U
    {
        ...
        public partial struct __Internal
        {
            ...
            [SuppressUnmanagedCodeSecurity, DllImport("LibuvSharp", EntryPoint = "??0<unnamed-type-u>@uv_idle_s@@QEAA@AEBT01@@Z", CallingConvention = CallingConvention.Cdecl)]
        ...
        {
            __instance = *(global::LibuvSharp.UvIdleS.U.__Internal*) native;
        }

        public U(global::LibuvSharp.UvIdleS.U __0)
            : this()
        {
    ...
    internal new static readonly global::System.Collections.Concurrent.ConcurrentDictionary<IntPtr, global::LibuvSharp.UvIdleS> NativeToManagedMap =
        new global::System.Collections.Concurrent.ConcurrentDictionary<IntPtr, global::LibuvSharp.UvIdleS>();

    internal static void __RecordNativeToManagedMapping(IntPtr native, global::LibuvSharp.UvIdleS managed)
    {
        NativeToManagedMap[native] = managed;
    }

    internal static bool __TryGetNativeToManagedMapping(IntPtr native, out global::LibuvSharp.UvIdleS managed)
    {
    ...
    public UvIdleS()
    {
        __Instance           = Marshal.AllocHGlobal(sizeof(global::LibuvSharp.UvIdleS.__Internal));
        __ownsNativeInstance = true;
        __RecordNativeToManagedMapping(__Instance, this);
    }

    public UvIdleS(global::LibuvSharp.UvIdleS _0)
    {
        __Instance           = Marshal.AllocHGlobal(sizeof(global::LibuvSharp.UvIdleS.__Internal));
        __ownsNativeInstance = true;
        __RecordNativeToManagedMapping(__Instance, this);
        *((global::LibuvSharp.UvIdleS.__Internal*) __Instance) = *((global::LibuvSharp.UvIdleS.__Internal*) _0.__Instance);
    }
    ...
    public global::LibuvSharp.UvIdleS.U u
    {
        get => global::LibuvSharp.UvIdleS.U.__CreateInstance(((__Internal*)__Instance)->u);
    ...
    public global::LibuvSharp.UvIdleS IdlePrev
    {
        get
        {
            var __result0 = global::LibuvSharp.UvIdleS.__GetOrCreateInstance(((__Internal*)__Instance)->idle_prev, false);
            return __result0;
        }
    ...
    public global::LibuvSharp.UvIdleS IdleNext
    {
        get
        {
            var __result0 = global::LibuvSharp.UvIdleS.__GetOrCreateInstance(((__Internal*)__Instance)->idle_next, false);
            return __result0;
        }
    ...
    public global::LibuvSharp.UvIdleCb IdleCb
    {
        get
        {
            var __ptr0 = ((__Internal*)__Instance)->idle_cb;
            return __ptr0 == IntPtr.Zero? null : (global::LibuvSharp.UvIdleCb) Marshal.GetDelegateForFunctionPointer(__ptr0, typeof(global::LibuvSharp.UvIdleCb));
        }

        set => ((__Internal*)__Instance)->idle_cb = value == null ? global::System.IntPtr.Zero : Marshal.GetFunctionPointerForDelegate(value);
    }
}