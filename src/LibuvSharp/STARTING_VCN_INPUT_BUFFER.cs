...
public unsafe partial class STARTING_VCN_INPUT_BUFFER : IDisposable
{
    ...
    internal static readonly ConcurrentDictionary<IntPtr, STARTING_VCN_INPUT_BUFFER> NativeToManagedMap =
        new ConcurrentDictionary<IntPtr, STARTING_VCN_INPUT_BUFFER>();

    internal static void __RecordNativeToManagedMapping(IntPtr native, STARTING_VCN_INPUT_BUFFER managed)
    {
        NativeToManagedMap[native] = managed;
    }

    internal static bool __TryGetNativeToManagedMapping(IntPtr native, out STARTING_VCN_INPUT_BUFFER managed)
    {
