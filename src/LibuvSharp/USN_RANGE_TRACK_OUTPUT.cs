...
public unsafe partial class USN_RANGE_TRACK_OUTPUT : IDisposable
{
    ...
    internal static readonly ConcurrentDictionary<IntPtr, USN_RANGE_TRACK_OUTPUT> NativeToManagedMap =
        new ConcurrentDictionary<IntPtr, USN_RANGE_TRACK_OUTPUT>();

    internal static void __RecordNativeToManagedMapping(IntPtr native, USN_RANGE_TRACK_OUTPUT managed)
    {
        NativeToManagedMap[native] = managed;
    }

    internal static bool __TryGetNativeToManagedMapping(IntPtr native, out USN_RANGE_TRACK_OUTPUT managed)
    {
