...
public static class UVFileAsync
{
    ...
    {
        return WrapExtensions.Wrap(loop, path, mode, UVFile.Chmod);
    }
    ...
    {
        return WrapExtensions.Wrap(loop, path, uid, gid, UVFile.Chown);
    }
    ...
    {
        return WrapExtensions.Wrap(loop, path, newPath, UVFile.Link);
    }
    ...
    {
        return WrapExtensions.Wrap(loop, path, UVFile.Unlink);
    }
    ...
    {
        return WrapExtensions.Wrap<Loop, string, UVFileAccess, UVFile>(loop, path, access, UVFile.Open);
    }

    public static Task Symlink(Loop loop, string path, string newPath)
    {
        return WrapExtensions.Wrap(loop, path, newPath, UVFile.Symlink);
    }
    ...
    {
        return WrapExtensions.Wrap<Loop, string, string>(loop, path, UVFile.Readlink);
    }
    ...
    {
        return WrapExtensions.Wrap(loop, file.Sync);
    }
    ...
    {
        return WrapExtensions.Wrap(loop, file.DataSync);
    }
    ...
    {
        return WrapExtensions.Wrap(loop, offset, file.Truncate);
    }
    ...
    {
        return WrapExtensions.Wrap(loop, mode, file.Chmod);
    }
    ...
    {
        return WrapExtensions.Wrap(loop, uid, gid, file.Chown);
    }
    ...
    {
        return WrapExtensions.Wrap<Loop, string, UVFileStat>(loop, path, UVFile.Stat);
    }
    ...
    {
        return WrapExtensions.Wrap<Loop, UVFileStat>(loop, file.Stat);
    }
